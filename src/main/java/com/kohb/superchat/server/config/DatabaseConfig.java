package com.kohb.superchat.server.config;
...
@Configuration
@EnableJpaRepositories("com.kohb.superchat.server.repository") //где все Jpa репозитории
@EnableTransactionManagement
@PropertySource("classpath:db.properties")
@ComponentScan("com.kohb.superchat.server")
public class DatabaseConfig {

    @Resource
    private Environment environment; //доступ к проперти файлам
    ...
    @Bean //бин необходимо развернуть на момент развертывания приложения
